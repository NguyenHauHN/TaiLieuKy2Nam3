...
namespace ThuctapCSDL
{
    public partial class frmHome : Form
    {
        ...
        private void cungCấpThiếtBịToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmDeviceProviding cc = new frmDeviceProviding();
            cc.ShowDialog();
        }

        private void nhàCungCấpToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            frmSupplier cc = new frmSupplier();
            cc.ShowDialog();
        }

        private void thiếtBịToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            frmDevice tb = new frmDevice();
            tb.ShowDialog();
        }

        private void loạiThiếtBịToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmDeviceType tb = new frmDeviceType();
            tb.ShowDialog();
        }
        ...
        private void phiếuNhậpThiếtBịToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmPhieuNhap _phieunhap = new frmPhieuNhap();
            _phieunhap.ShowDialog();
        }
    }
}
